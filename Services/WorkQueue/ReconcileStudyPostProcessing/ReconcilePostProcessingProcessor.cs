...
using MatrixPACS.ImageServer.Services.WorkQueue.StudyProcess;
...
namespace MatrixPACS.ImageServer.Services.WorkQueue.ReconcileStudyPostProcessing
{
    ...
    class ReconcilePostProcessingProcessor : StudyProcessItemProcessor
	{
		...
		protected override void ProcessFile(Model.WorkQueueUid queueUid, DicomFile file, MatrixPACS.Dicom.Utilities.Xml.StudyXml stream, bool compare)
		{
