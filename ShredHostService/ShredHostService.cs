...
namespace MatrixPACS.ImageServer.ShredHostService
{
    public partial class ShredHostService : ServiceBase
    {
        ...
        internal static void InternalStart()
        {
            ...
            // MatrixPACS.Server.ShredHost.dll would also need to be Strong Name signed
            _assembly = Assembly.Load("MatrixPACS.Server.ShredHost");
            _shredHostType = _assembly.GetType("MatrixPACS.Server.ShredHost.ShredHost");
