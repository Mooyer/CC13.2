...
namespace MatrixPACS.ImageServer.Model.EntityBrokers
{
    ...
    public partial class DeviceSelectCriteria : EntitySelectCriteria
    {
        ...
        public ISearchCondition<String> DefaultSCS
        {
            get
            {
                if (!SubCriteria.ContainsKey("DefaultSCS"))
                {
                    SubCriteria["DefaultSCS"] = new SearchCondition<String>("DefaultSCS");
                }
                return (ISearchCondition<String>)SubCriteria["DefaultSCS"];
            }
        }
