...
namespace MatrixPACS.ImageServer.Model.EntityBrokers
{
   ...
   public partial class DeviceUpdateColumns : EntityUpdateColumns
   {
       ...
       {}
        ...
        // DefaultSCS, set the default Specific character set.Used for enconding characters when no (0008.0005) tag not included in the image data
        [EntityFieldDatabaseMappingAttribute(TableName = "Device", ColumnName = "DefaultSCS")]
        public String DefaultSCS
        {
            set { SubParameters["DefaultSCS"] = new EntityUpdateColumn<String>("DefaultSCS", value); }
        }
