...
namespace MatrixPACS.ImageServer.Model.SqlServer.CodeGenerator
{
    public class Generator
    {
        ...
        private void WriterHeader(TextWriter writer, string nameSpace)
        {
            ...
            if (Proprietary)
            {
                writer.WriteLine("// Copyright (c) 2013, MatrixPACS Inc.");
                writer.WriteLine("// All rights reserved.");
                writer.WriteLine("// http://www.MatrixPACS.ca");
                writer.WriteLine("//");
                writer.WriteLine("// For information about the licensing and copyright of this software please");
                writer.WriteLine("// contact MatrixPACS, Inc. at info@MatrixPACS.ca");
            }
            else
            {
                writer.WriteLine("// Copyright (c) 2013, MatrixPACS Inc.");
                ...
                writer.WriteLine("// http://www.MatrixPACS.ca");
                writer.WriteLine("//");
                writer.WriteLine("// This file is part of the MatrixPACS RIS/PACS open source project.");
                writer.WriteLine("//");
                writer.WriteLine("// The MatrixPACS RIS/PACS open source project is free software: you can");
                ...
                writer.WriteLine("//");
                writer.WriteLine("// The MatrixPACS RIS/PACS open source project is distributed in the hope that it");
                ...
                writer.WriteLine("// the MatrixPACS RIS/PACS open source project.  If not, see");
                writer.WriteLine("// <http://www.gnu.org/licenses/>.");
            }
            writer.WriteLine("");
            writer.WriteLine("#endregion");
            writer.WriteLine("");
            writer.WriteLine("// This file is auto-generated by the MatrixPACS.Model.SqlServer.CodeGenerator project.");
            writer.WriteLine("");
        ...
        private void WriteEnumBrokerInterfaceFile(Table table)
        {
            ...
            writer.WriteLine("    using MatrixPACS.ImageServer.Enterprise;");
            writer.WriteLine("");
        ...
        private void WriteEnumBrokerImplementationFile(Table table)
        {
            ...
            writer.WriteLine("    using MatrixPACS.Common;");
            writer.WriteLine("    using {0};", EntityInterfaceNamespace);
            writer.WriteLine("    using MatrixPACS.ImageServer.Enterprise.SqlServer;");
            writer.WriteLine("");
        ...
        private void WriteModelFile(Table table)
        {
            ...
            if (bDicomReference)
                writer.WriteLine("    using MatrixPACS.Dicom;");
            writer.WriteLine("    using MatrixPACS.Enterprise.Core;");
            writer.WriteLine("    using MatrixPACS.ImageServer.Enterprise;");
            writer.WriteLine("    using MatrixPACS.ImageServer.Enterprise.Command;");
            writer.WriteLine("    using {0};", EntityInterfaceNamespace);
            writer.WriteLine("");
