namespace MatrixPACS.ImageServer.TestApp
{
    partial class TestSendImagesForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.checkableGroupBox2 = new MatrixPACS.ImageServer.TestApp.CheckableGroupBox();
			...
			this.checkableGroupBox1 = new MatrixPACS.ImageServer.TestApp.CheckableGroupBox();
