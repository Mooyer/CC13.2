...
namespace MatrixPACS.ImageServer.TestApp
{
    ...
    public class ProductVerificationTester
    {
        public ProductVerificationResponse Verify()
        {
            ...
            EndpointAddress endpoint = new EndpointAddress(String.Format("http://localhost:{0}/MatrixPACS.ImageServer.Common.ServiceModel.IProductVerificationService", port));
