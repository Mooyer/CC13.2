            ...
            using (var service = new AuthorityRead())
            {
                ...
                CollectionUtils.ForEach(
                    ...
                    delegate(AuthorityGroupDetail group)
                    {
                        ...
                        {
                            if (token.Name.Equals(MatrixPACS.Enterprise.Common.AuthorityTokens.DataAccess.AllPartitions))
                            {
                                allPartitions = true;                                
                            }
                            else if (token.Name.Equals(MatrixPACS.Enterprise.Common.AuthorityTokens.DataAccess.AllStudies))
                            {
                                allStudies = true;
                            }
