...
namespace MatrixPACS.ImageServer.Web.Common.WebControls.Validators
{
    ...
    /// 
    /// <MatrixPACS:ConditionalRequiredFieldValidator 
    ...
    public class ConditionalRequiredFieldValidator : BaseValidator
    {
        ...
        //                               "MatrixPACS.ImageServer.Web.Common.WebControls.ConditionalRequiredFieldValidator_OnValidate_Conditional.js");
        ...
        //        ScriptTemplate template =
        //            new ScriptTemplate(GetType().Assembly,
        //                               "MatrixPACS.ImageServer.Web.Common.WebControls.ConditionalRequiredFieldValidator_OnValidate.js");
        //        template.Replace("@@CLIENTID@@", ClientID); 
        //        template.Replace("@@FUNCTION_NAME@@", ClientEvalFunctionName);
        //        template.Replace("@@INPUT_CLIENTID@@", InputControl.ClientID);
        //        template.Replace("@@ERROR_MESSAGE@@", ErrorMessage);
