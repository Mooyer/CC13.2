...
namespace MatrixPACS.ImageServer.Web.Common.WebControls.Validators
{
    ...
    ///     Visible="true"/>
    ///                                                        
    /// <MatrixPACS:FilesystemPathValidator runat="server" ID="PasswordValidator" 
    ...
    public class LengthValidator : BaseValidator
    {
        ...
        {
            var template =
                new ScriptTemplate(this, "MatrixPACS.ImageServer.Web.Common.WebControls.Validators.LengthValidator.js");
