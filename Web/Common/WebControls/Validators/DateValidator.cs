...
namespace MatrixPACS.ImageServer.Web.Common.WebControls.Validators
{
    ...
    ///     Visible="true"/>
    ///                                                        
    /// <MatrixPACS:DateValidator runat="server" ID="DateValidator" 
    ...
    public class DateValidator : BaseValidator
    {
        ...
        {
            var template =
                new ScriptTemplate(this, "MatrixPACS.ImageServer.Web.Common.WebControls.Validators.DateValidator.js");
