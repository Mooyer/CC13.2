...
namespace MatrixPACS.ImageServer.Web.Common.WebControls.UI
{
    ...
    /// <code>
    /// 
    /// <%@ Register Assembly="MatrixPACS.ImageServer.Web.Common" Namespace="MatrixPACS.ImageServer.Web.Common.WebControls.UI" TagPrefix="MatrixPACS" %>
    /// ...
    /// <MatrixPACS:DateTimeLabel ID="Today" runat="server" ForeColor="white" Format="MMM/dd/yyyy" EmptyValueText="Unknown"></MatrixPACS:DateTimeLabel>
    /// 
    /// 
    /// </code>
    /// </example>
