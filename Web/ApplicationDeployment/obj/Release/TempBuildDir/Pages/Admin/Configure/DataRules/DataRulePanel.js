...
Type.registerNamespace('MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules');

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Constructor
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel = function(element) {
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel.initializeBase(this, [element]);
},

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Create the prototype for the control.
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel.prototype =
{
    initialize: function() {

    MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel.callBaseMethod(this, 'initialize');
    ...
    dispose: function() {
        ...
        MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel.callBaseMethod(this, 'dispose');
...
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel.registerClass('MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.DataRules.DataRulePanel', Sys.UI.Control);
