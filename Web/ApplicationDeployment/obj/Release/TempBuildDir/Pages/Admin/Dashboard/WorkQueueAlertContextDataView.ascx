...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkQueueAlertContextDataView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Dashboard.WorkQueueAlertContextDataView" %>
