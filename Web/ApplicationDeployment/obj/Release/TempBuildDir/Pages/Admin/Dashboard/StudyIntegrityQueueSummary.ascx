...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudyIntegrityQueueSummary.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Dashboard.StudyIntegrityQueueSummary" %>
