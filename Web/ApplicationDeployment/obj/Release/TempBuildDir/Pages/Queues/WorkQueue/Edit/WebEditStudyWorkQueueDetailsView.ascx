...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebEditStudyWorkQueueDetailsView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.WebEditStudyWorkQueueDetailsView" %>
