...
<%@ Import Namespace="MatrixPACS.ImageServer.Core.Data" %>
<%@ Import Namespace="MatrixPACS.ImageServer.Web.Common.Utilities" %>
<%@ Import Namespace="MatrixPACS.Dicom.Utilities.Command" %>
<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ReconcileHistoryDetailsColumn.ascx.cs"
    Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.ReconcileHistoryDetailsColumn" %>
<%@ Import Namespace="MatrixPACS.Dicom"%>
