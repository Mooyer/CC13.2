...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompressionHistory.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.CompressionHistory" %>
