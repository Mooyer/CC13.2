...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudyStorageView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.StudyStorageView" %>
