...
<%@ Import namespace="MatrixPACS.ImageServer.Common.Utilities"%>


<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HistoryPanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.HistoryPanel" %>
