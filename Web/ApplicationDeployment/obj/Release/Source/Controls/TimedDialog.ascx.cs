...
namespace MatrixPACS.ImageServer.Web.Application.Controls
{
    ...
    /// aspx code:
    /// 
    /// <%@ Register Src="TimedDialog.ascx" TagName="TimedDialog" TagPrefix="MatrixPACS" %>
    /// <MatrixPACS:TimedDialog ID="TimedDialog" runat="server" Timeout="5000" ShowOkButton="false" />
    /// 
    /// C#:
    /// 
