...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginWarningIndicator.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Controls.LoginWarningIndicator" %>
