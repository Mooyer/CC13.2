...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserGroupsGridPanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.UserManagement.UserGroups.UserGroupsGridPanel" %>

<asp:Table runat="server" ID="ContainerTable" Height="100%" CellPadding="0" CellSpacing="0" Width="100%">
    <asp:TableRow VerticalAlign="top">
        <asp:TableCell>
        <asp:ObjectDataSource ID="UserGroupDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.UserGroupDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.UserGroupRowData" EnablePaging="true"
