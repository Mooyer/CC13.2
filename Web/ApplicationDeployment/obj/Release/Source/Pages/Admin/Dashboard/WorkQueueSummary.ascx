...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkQueueSummary.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Dashboard.WorkQueueSummary" %>
