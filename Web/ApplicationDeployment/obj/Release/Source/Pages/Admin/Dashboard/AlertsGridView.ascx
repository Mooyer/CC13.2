...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AlertsGridView.ascx.cs"
	Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Dashboard.AlertsGridView" %>
    ...
    <asp:TableRow VerticalAlign="top">
		<asp:TableCell VerticalAlign="top">
			<asp:ObjectDataSource ID="AlertDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.AlertDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.AlertSummary"
