...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AlertHoverPopupDetails.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Alerts.AlertHoverPopupDetails" %>
