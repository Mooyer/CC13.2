...
<%@ Control Language="C#" AutoEventWireup="true" Codebehind="AlertsGridPanel.ascx.cs"
    Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Alerts.AlertsGridPanel" %>
...
<asp:Table runat="server" ID="ContainerTable" Height="100%" CellPadding="0" CellSpacing="0"
    ...
    <asp:TableRow VerticalAlign="top">
        <asp:TableCell VerticalAlign="top">   
            <asp:ObjectDataSource ID="AlertDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.AlertDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.AlertSummary" EnablePaging="true"
