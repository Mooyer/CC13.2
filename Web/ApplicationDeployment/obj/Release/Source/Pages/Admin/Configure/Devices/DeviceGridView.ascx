...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices.DeviceGridView"
        ...
        <asp:TableCell VerticalAlign="top">
            <ccUI:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DefaultSCS" HeaderText="<%$Resources: ColumnHeaders,DefaultSCS %>" HeaderStyle-HorizontalAlign="Left">
                    </asp:BoundField>
