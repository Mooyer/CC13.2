...
[assembly:
    WebResource("MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices.DevicePanel.js",
        "application/x-javascript")]

namespace MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices
{
    /// <summary>
    /// Panel to display list of devices for a particular server partition.
    /// </summary>
    [ClientScriptResource(
        ComponentType = "MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices.DevicePanel",
        ResourcePath = "MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices.DevicePanel.js")]    
