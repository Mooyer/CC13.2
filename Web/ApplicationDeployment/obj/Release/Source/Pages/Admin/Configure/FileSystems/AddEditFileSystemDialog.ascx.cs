...
namespace MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems
{
    ...
    public partial class AddFilesystemDialog : UserControl
    {
        ...
        {
            ScriptTemplate template = new ScriptTemplate(typeof(AddFilesystemDialog).Assembly, "MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.Filesystem.js");
