...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataAccessGroupPanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.ServerPartitions.DataAccessGroupPanel" %>
