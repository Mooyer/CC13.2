...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeletedStudyDetailsDialogPanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Audit.DeletedStudies.DeletedStudyDetailsDialogPanel" %>
