...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchResultGridView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Audit.DeletedStudies.SearchResultGridView" %>
	...
	<asp:TableRow VerticalAlign="top">
		<asp:TableCell VerticalAlign="top">
            ...
            <asp:ObjectDataSource ID="DataSource" runat="server" 
                TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.DeletedStudyDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.Model.DeletedStudyInfo" 
				EnablePaging="true"
				SelectMethod="Select"
