...
<%@ Import Namespace="MatrixPACS.ImageServer.Core.Helpers" %>
...
<%@ Control Language="C#" AutoEventWireup="true" Codebehind="WorkQueueItemList.ascx.cs"
	Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.WorkQueueItemList" %>
<%@ Import Namespace="Resources"%>
<%@ Import Namespace="MatrixPACS.ImageServer.Model"%>
<%@ Import Namespace="MatrixPACS.ImageServer.Common"%>
<%@ Import Namespace="MatrixPACS.ImageServer.Web.Common.Data.DataSource"%>
<%@ Import Namespace="MatrixPACS.ImageServer.Web.Common.Data"%>
		...
		<asp:Table runat="server" ID="ListContainerTable" Height="100%" CellPadding="0" CellSpacing="0"
			...
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell ID="ListContainerCell" CssClass="GlobalGridViewPanelContent" VerticalAlign="top">
					<asp:ObjectDataSource ID="WorkQueueDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.WorkQueueDataSource"
						DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.WorkQueueSummary" EnablePaging="true"
