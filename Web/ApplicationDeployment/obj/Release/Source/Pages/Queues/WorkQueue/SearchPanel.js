...
Type.registerNamespace('MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue');

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Constructor
MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel = function(element) { 
    MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel.initializeBase(this, [element]);
},

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Create the prototype for the control.
MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel.prototype = 
{
    initialize : function() {
        
        MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel.callBaseMethod(this, 'initialize');        
    ...
    dispose : function() {
        ...
        MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel.callBaseMethod(this, 'dispose');
...
MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel.registerClass('MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.SearchPanel', Sys.UI.Control);
