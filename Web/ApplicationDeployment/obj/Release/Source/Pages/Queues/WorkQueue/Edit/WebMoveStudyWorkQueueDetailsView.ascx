...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebMoveStudyWorkQueueDetailsView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.WebMoveStudyWorkQueueDetailsView" %>
