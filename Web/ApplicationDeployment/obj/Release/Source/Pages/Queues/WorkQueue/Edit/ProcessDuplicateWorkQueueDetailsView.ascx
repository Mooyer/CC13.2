...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcessDuplicateWorkQueueDetailsView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.ProcessDuplicateWorkQueueDetailsView" %>
