...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TierMigrationWorkQueueDetailsView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.WorkQueue.Edit.TierMigrationWorkQueueDetailsView" %>
