...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SeriesDetailsView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.SeriesDetails.SeriesDetailsView" %>
