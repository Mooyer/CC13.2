...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateAuthorityGroupDialog.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.AddAuthorityGroupDialog" %>
