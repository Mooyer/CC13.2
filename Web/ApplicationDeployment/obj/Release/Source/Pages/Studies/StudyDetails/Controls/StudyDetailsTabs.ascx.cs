...
[assembly: WebResource("MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Scripts.StudyDetailsTabs.js", "application/x-javascript")]

namespace MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls
{
    [ClientScriptResource(ComponentType = "MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Controls.StudyDetailsTabs",
                          ResourcePath = "MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails.Scripts.StudyDetailsTabs.js")]    
    public partial class StudyDetailsTabs : ScriptUserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            //DataAccessTabPanel.Visible = Thread.CurrentPrincipal.IsInRole(MatrixPACS.Enterprise.Common.AuthorityTokens.Admin.Security.AuthorityGroup);
            //DataAccessTabPanel.Enabled = Thread.CurrentPrincipal.IsInRole(MatrixPACS.ImageServer.Enterprise.Authentication.AuthorityTokens.Study.EditDataAccess);
