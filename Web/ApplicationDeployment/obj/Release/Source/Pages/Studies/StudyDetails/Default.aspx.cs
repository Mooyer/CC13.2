...
using Resources;
using StudyNotFoundException=MatrixPACS.ImageServer.Web.Common.Exceptions.StudyNotFoundException;

namespace MatrixPACS.ImageServer.Web.Application.Pages.Studies.StudyDetails
{
    /// <summary>
    /// Study details page.
    /// </summary>
