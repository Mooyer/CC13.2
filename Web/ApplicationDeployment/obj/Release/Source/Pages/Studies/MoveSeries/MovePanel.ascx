...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MovePanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Studies.MoveSeries.MovePanel" %>
