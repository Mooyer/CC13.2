...
using MatrixPACS.ImageServer.Web.Common.WebControls.Validators;

namespace MatrixPACS.ImageServer.Web.Application.Services
{
    /// <summary>
    /// Provides data validation services
    /// </summary>
    [WebService(Namespace = "http://www.MatrixPACS.ca/ImageServer/Services/ValidationServices.asmx")]
