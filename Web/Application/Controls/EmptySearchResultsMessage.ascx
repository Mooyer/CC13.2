...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmptySearchResultsMessage.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Controls.EmptySearchResultsMessage" %>
