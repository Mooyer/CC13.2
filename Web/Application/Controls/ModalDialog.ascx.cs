...
namespace MatrixPACS.ImageServer.Web.Application.Controls
{
    ...
    /// aspx code:
    /// 
    /// <%@ Register Src="ModalDialog.ascx" TagName="ModalDialog" TagPrefix="MatrixPACS" %>
    /// 
    /// <MatrixPACS:ModalDialog ID="ModalDialog1" runat="server" Title="Please Press the button">
    /// <ContentTemplate>
    ///      <asp:Button ID="YesButton" runat="server" OnClick="Button_Click" Text="Click Me" />
    /// </ContentTemplate>
    /// </MatrixPACS:ModalDialog>
    /// 
    /// 
    /// C#:
    /// 
