...
<%@ Import namespace="MatrixPACS.ImageServer.Web.Application.Helpers"%>
<%@ Import namespace="MatrixPACS.ImageServer.Web.Common.Data.Model"%>


<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeletedStudyDetailsDialogGeneralPanel.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Audit.DeletedStudies.DeletedStudyDetailsDialogGeneralPanel" %>
