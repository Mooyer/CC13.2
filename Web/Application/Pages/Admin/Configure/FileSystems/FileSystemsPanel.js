...
Type.registerNamespace('MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems');

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Constructor
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel = function(element) { 
    MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel.initializeBase(this, [element]);
},

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Create the prototype for the control.
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel.prototype = 
{
    initialize : function() {
                       
        MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel.callBaseMethod(this, 'initialize');        
    ...
    dispose : function() {
        ...
        MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel.callBaseMethod(this, 'dispose');
...
MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel.registerClass('MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.FileSystems.FileSystemsPanel', Sys.UI.Control);
