...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.Configure.Devices.AddEditDeviceDialog"
                ...
                <ContentTemplate>
                    <table id="Table2" runat="server">
                        ...
                        <tr id="Tr3" runat="server" align="left" valign="bottom">
                            ...
                            <td id="Td10" runat="server" valign="bottom">
                                <table>
                                    <tr align="left">
                                        <td>
                                            <asp:Label ID="Label10" runat="server" Text="<%$Resources: InputLabels, DefaultSCS %>" CssClass="DialogTextBoxLabel" /><br />
                                            <asp:TextBox ID="DefaultSCSTextBox" runat="server" CssClass="DialogTextBox" />
                                        </td>
                                        <td valign="bottom">
