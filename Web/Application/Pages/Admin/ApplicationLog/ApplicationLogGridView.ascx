...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplicationLogGridView.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Admin.ApplicationLog.ApplicationLogGridView" %>
...
<asp:Table runat="server" ID="ContainerTable" Height="100%" CellPadding="0" CellSpacing="0"
    ...
    <asp:TableRow VerticalAlign="top">
        ...
        <asp:ObjectDataSource ID="ApplicationLogDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.ApplicationLogDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Model.ApplicationLog" EnablePaging="true"
