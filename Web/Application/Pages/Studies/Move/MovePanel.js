...
Type.registerNamespace('MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move');

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Constructor
MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel = function(element) { 
    MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel.initializeBase(this, [element]);
},

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// Create the prototype for the control.
MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel.prototype =
{
    initialize: function() {

        MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel.callBaseMethod(this, 'initialize');
    ...
    dispose: function() {
        ...
        MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel.callBaseMethod(this, 'dispose');
...
MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel.registerClass('MatrixPACS.ImageServer.Web.Application.Pages.Studies.Move.MovePanel', Sys.UI.Control);     
