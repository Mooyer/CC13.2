...
[assembly: WebResource("MatrixPACS.ImageServer.Web.Application.Pages.Studies.SearchPanel.js", "application/x-javascript")]

namespace MatrixPACS.ImageServer.Web.Application.Pages.Studies
{
    ...
    [ClientScriptResource(ComponentType="MatrixPACS.ImageServer.Web.Application.Pages.Studies.SearchPanel", ResourcePath="MatrixPACS.ImageServer.Web.Application.Pages.Studies.SearchPanel.js")]
    public partial class SearchPanel : AJAXScriptControl, IStudySearchPage
    {
        ...
        public string ViewImagePageUrl
        {
            get
            {
//                if (!Thread.CurrentPrincipal.IsInRole(MatrixPACS.ImageViewer.AuthorityTokens.ViewerClinical))
//                    return Page.ResolveClientUrl(ImageServerConstants.PageURLs.EmbeddedViewImagesPage);
        ...
        private void SetupChildControls()
        {
            ...
            AssignAuthorityGroupsButton.Roles = MatrixPACS.ImageServer.Common.Authentication.AuthorityTokens.Study.EditDataAccess;
        }
