...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.ArchiveQueue.ArchiveQueueItemList"
	Codebehind="ArchiveQueueItemList.ascx.cs" %>
<asp:Table runat="server" ID="ContainerTable" Height="100%" CellPadding="0" CellSpacing="0"
	Width="100%">
	<asp:TableRow VerticalAlign="top">
		<asp:TableCell VerticalAlign="top">
			<asp:ObjectDataSource ID="ArchiveQueueDataSourceObject" runat="server" TypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.ArchiveQueueDataSource"
				DataObjectTypeName="MatrixPACS.ImageServer.Web.Common.Data.DataSource.ArchiveQueueSummary" EnablePaging="true"
