...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SIQEntryTooltip.ascx.cs" Inherits="MatrixPACS.ImageServer.Web.Application.Pages.Queues.StudyIntegrityQueue.SIQEntryTooltip" %>
