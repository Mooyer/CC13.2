...
namespace Resources {
    ...
    internal class Tooltips {
        ...
        /// <summary>
        ///   查找类似 This device can send Accept Key/Object Presentation States objects to the server 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The server can auto-route images to this device 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This device can query the server 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This device can retrieve images from the server 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This device can send DICOM images to the server 的本地化字符串。
        /// </summary>
