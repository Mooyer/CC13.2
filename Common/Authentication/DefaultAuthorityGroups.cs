...
using MatrixPACS.Common.Authorization;
using MatrixPACS.Common.Utilities;

namespace MatrixPACS.ImageServer.Common.Authentication
{
        ...
        public AuthorityGroupDefinition[] GetAuthorityGroups()
        {
            ...
            AuthorityGroupDefinition admins = new AuthorityGroupDefinition(
                ...
                new string[]
                    {
                        #region Tokens
                        MatrixPACS.Enterprise.Common.AuthorityTokens.Admin.Security.User,
                        MatrixPACS.Enterprise.Common.AuthorityTokens.Admin.Security.AuthorityGroup,
